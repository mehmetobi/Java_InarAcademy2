package Chapters.Chapter12.Exercises12.Exercises12_Soru25;

import java.io.File;
import java.util.Scanner;

public class Exercises12_Soru25 {

    public static void main(String[] args) throws Exception {

        File file = new File("C:\\Users\\mehmetobi\\workspace\\InarAcademy\\Java_InarAcademy\\Salary.txt");
        if (!file.exists()) {
